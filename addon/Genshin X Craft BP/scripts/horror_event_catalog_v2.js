...
const watcherLinked = [
  ...
  event('fog_silhouette', E.WatcherLinked, R.Major, 4, 20, score({ base: 4, fields: [['openSpace', 6], ['darkness', 4], ['tensionNorm', 5]] }), [sound(0, 'paradise.ambient.low_hum', 'far_ahead', { volume: 0.2, pitch: 0.6 }), vhs(5, 'low', S(2)), watcher(8, 'fog', 'far_ahead'), sound(15, 'paradise.stalker.roar_muffled', 'far_ahead', { volume: 0.16, pitch: 0.55 }), sound(17, 'paradise.stalker.stinger', 'far_ahead', { volume: 0.24, pitch: 0.72 })]),
